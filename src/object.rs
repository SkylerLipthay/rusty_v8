...
impl Object {
  ...
  pub fn has<'s>(
    ...
    unsafe {
      v8__Object__Has(self, &*scope.get_current_context(), &*key)
    }
    .into()
  }
  ...
  pub fn has_index<'s>(
    ...
    unsafe {
      v8__Object__HasIndex(self, &*scope.get_current_context(), index)
    }
    .into()
  }
  ...
  pub fn delete<'s>(
    ...
    unsafe {
      v8__Object__Delete(self, &*scope.get_current_context(), &*key)
    }
    .into()
  }
